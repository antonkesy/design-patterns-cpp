...
#define DESIGN_PATTERN_CPP_VISITOR_H
    ...
    public:
        ...
        {
            std::cout << "Concrete Visitor 1 visited by Concrete Element A" << std::endl;
        }

        void VisitConcreteElementB(ConcreteElementB* concreteElementB) override
        {
            std::cout << "Concrete Visitor 1 visited by Concrete Element B" << std::endl;
        }
    };
    ...
    public:
        ...
        void VisitConcreteElementA(ConcreteElementA* concreteElementA) override
        {
            std::cout << "Concrete Visitor 2 visited by Concrete Element A" << std::endl;
        }

        void VisitConcreteElementB(ConcreteElementB* concreteElementB) override
        {
            std::cout << "Concrete Visitor 2 visited by Concrete Element B" << std::endl;
        }
    };
